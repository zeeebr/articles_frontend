                    ...
                    <table className="counter-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{this.state.data.wos['2021']}<sup>&nbsp;{this.state.data.wos['2021+'] > 0 ? '+'+this.state.data.wos['2021+'] : ''}</sup></td>
                            ...
                            <tr>
                                ...
                                <td>{this.state.data.scopus['2021']}<sup>&nbsp;{this.state.data.scopus['2021+'] > 0 ? '+'+this.state.data.scopus['2021+'] : ''}</sup></td>
                            ...
                            <tr>
                                ...
                                <td>{this.state.data.all['2021']}</td>
